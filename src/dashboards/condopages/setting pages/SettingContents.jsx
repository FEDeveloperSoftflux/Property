...
export default function SettingsContent({ activeTab }) {
  ...
  const handleProfilePicChange = (e) => {
    ...
    if (file) {
      ...
      // If you need to send it to server:
    ...
    <div className="bg-white border-gray-200">
      ...
      {activeTab === "profile" && (
        <div className="p-8 pt-1">
          <h2 className="text-2xl font-semibold text-gray-900 ml-0 pl-0 mb-2">
            Profile Settings
          </h2>
          ...
          <div className="mt-12 space-y-6">
            <div className="grid grid-cols-2 gap-6">
              <input
                ...
                className="px-4 py-3 bg-neutral-50 border rounded-lg"
              />
              <input
                name="lastName"
      ...
      {activeTab === "security" && (
        <div className="p-8">
          ...
          <input
            ...
            className="mt-6 w-full px-4 py-3 bg-neutral-50 border rounded-lg"
          />
